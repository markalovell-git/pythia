...
TRANSIT_IN_SIGN: dict[tuple[str, str], str] = {
    ...
    # North Node (moves retrograde, ~18 months per sign — use collective evolutionary language)
    ("North Node", "Aries"):       "The transiting North Node is moving through Aries, marking a period when the collective evolutionary call is toward individual courage, self-initiation, and the willingness to act without waiting for permission. The soul of the age is learning to trust instinct over consensus.",
    ("North Node", "Taurus"):      "The transiting North Node is moving through Taurus, marking a period when the collective evolutionary call is toward embodiment, material simplicity, and the patient building of what endures. The soul of the age is learning that genuine security comes from stability, not restlessness.",
    ("North Node", "Gemini"):      "The transiting North Node is moving through Gemini, marking a period when the collective evolutionary call is toward curiosity, honest exchange, and openness to multiple perspectives. The soul of the age is learning to gather information rather than rush toward fixed conclusions.",
    ("North Node", "Cancer"):      "The transiting North Node is moving through Cancer, marking a period when the collective evolutionary call is toward emotional depth, care, and genuine belonging. The soul of the age is learning that vulnerability and nurturing are strengths rather than weaknesses.",
    ("North Node", "Leo"):         "The transiting North Node is moving through Leo, marking a period when the collective evolutionary call is toward authentic creative expression and the warmth of personal joy. The soul of the age is learning to lead with the heart and to celebrate the individual as well as the group.",
    ("North Node", "Virgo"):       "The transiting North Node is moving through Virgo, marking a period when the collective evolutionary call is toward practical service, discernment, and the satisfaction of real usefulness. The soul of the age is learning to find meaning in careful, committed work.",
    ("North Node", "Libra"):       "The transiting North Node is moving through Libra, marking a period when the collective evolutionary call is toward genuine partnership, balance, and fair-minded cooperation. The soul of the age is learning that strength includes the willingness to consider others honestly.",
    ("North Node", "Scorpio"):     "The transiting North Node is moving through Scorpio, marking a period when the collective evolutionary call is toward depth, transformation, and the courage to face what has been hidden. The soul of the age is learning to move through loss and renewal rather than avoid it.",
    ("North Node", "Sagittarius"): "The transiting North Node is moving through Sagittarius, marking a period when the collective evolutionary call is toward vision, philosophy, and the willingness to follow truth beyond what is comfortable. The soul of the age is learning to move from information to genuine wisdom.",
    ("North Node", "Capricorn"):   "The transiting North Node is moving through Capricorn, marking a period when the collective evolutionary call is toward responsibility, long-term thinking, and the building of lasting structures. The soul of the age is learning to take genuine authority over its own choices.",
    ("North Node", "Aquarius"):    "The transiting North Node is moving through Aquarius, marking a period when the collective evolutionary call is toward community, innovation, and the willingness to serve something larger than personal comfort. The soul of the age is learning to place collective vision above ego preference.",
    ("North Node", "Pisces"):      "The transiting North Node is moving through Pisces, marking a period when the collective evolutionary call is toward compassion, spiritual trust, and the willingness to dissolve into something larger than the self. The soul of the age is learning that surrender and faith are a form of intelligence.",

    # South Node (always opposite North Node — collective karmic release language)
    ("South Node", "Aries"):       "The transiting South Node is moving through Aries, releasing old collective patterns of impulsive self-assertion and the warrior instinct of going it alone. Past gifts of courage and initiative are available to be redirected toward cooperation and evolutionary purpose.",
    ("South Node", "Taurus"):      "The transiting South Node is moving through Taurus, releasing old collective patterns of material clinging and the ingrained habit of measuring security in purely physical terms. Past gifts of patience and endurance are available to be redirected toward genuine transformation.",
    ("South Node", "Gemini"):      "The transiting South Node is moving through Gemini, releasing old collective patterns of restless information-gathering and the avoidance of commitment to any single truth. Past gifts of wit and versatility are available to be put to more purposeful use.",
    ("South Node", "Cancer"):      "The transiting South Node is moving through Cancer, releasing old collective patterns of emotional dependency and tribal comfort. Past gifts of sensitivity and care are available, though the invitation is to mature them beyond familiar comfort-seeking.",
    ("South Node", "Leo"):         "The transiting South Node is moving through Leo, releasing old collective patterns of ego-centrism and the craving for personal recognition. Past gifts of creative warmth and generous expression are available to be offered in service of the collective.",
    ("South Node", "Virgo"):       "The transiting South Node is moving through Virgo, releasing old collective patterns of over-analysis and the compulsion to have everything perfectly in order before moving. Past gifts of precision and discernment are available to serve a larger purpose.",
    ("South Node", "Libra"):       "The transiting South Node is moving through Libra, releasing old collective patterns of excessive accommodation and the chronic need to smooth over conflict rather than face it honestly. Past gifts of diplomacy and relational grace are available to be reclaimed.",
    ("South Node", "Scorpio"):     "The transiting South Node is moving through Scorpio, releasing old collective patterns of power struggle and attachment to intensity for its own sake. Past gifts of penetrating depth and transformative power are available to be directed toward genuine renewal.",
    ("South Node", "Sagittarius"): "The transiting South Node is moving through Sagittarius, releasing old collective patterns of dogmatic certainty and restless wandering. Past gifts of vision and optimism are available to be grounded in genuine discernment.",
    ("South Node", "Capricorn"):   "The transiting South Node is moving through Capricorn, releasing old collective patterns of rigid authority and the mistaken equation of status with worth. Past gifts of discipline and mastery are available to be redirected toward human rather than institutional ends.",
    ("South Node", "Aquarius"):    "The transiting South Node is moving through Aquarius, releasing old collective patterns of detachment and ideological rigidity. Past gifts of visionary thinking and collective awareness are available to be warmed by genuine personal engagement.",
    ("South Node", "Pisces"):      "The transiting South Node is moving through Pisces, releasing old collective patterns of spiritual bypassing and the dissolution of boundaries that should be maintained. Past gifts of compassion and spiritual sensitivity are available to be grounded in practical, discerning service.",
}
...
TRANSIT_TO_NATAL: dict[tuple[str, str, str], str] = {
    ...
    # ── Transiting North Node to natal planets ────────────────────────────────
    # The North Node moves slowly (~18 months per sign, retrograde).
    # Its transit to a natal planet activates the karmic growth dimension of that planet.

    # Transiting North Node → natal Sun
    ("North Node", "Sun", "conjunction"):  "The transiting North Node is crossing your natal Sun, aligning your core identity with the collective soul's current growth direction. Who you are and who you are becoming are briefly pointing toward the same horizon — a meaningful window for choices that feel both personally authentic and genuinely forward-facing.",
    ("North Node", "Sun", "sextile"):      "The transiting North Node is in a supportive relationship with your natal Sun, making it easier to express who you are in ways that also serve your growth direction. Identity and evolution cooperate naturally; choices made from genuine self-expression tend to point meaningfully forward.",
    ("North Node", "Sun", "square"):       "The transiting North Node is squaring your natal Sun, creating productive friction between personal self-expression and the direction of evolutionary growth. Something about how you are showing up may be at odds with where your soul is calling you — the tension is useful for naming the gap.",
    ("North Node", "Sun", "trine"):        "The transiting North Node is flowing harmoniously with your natal Sun, aligning personal identity with evolutionary purpose. Being fully yourself tends to move you forward rather than sideways right now — a good period for authentic choices that serve the soul's larger direction.",
    ("North Node", "Sun", "opposition"):   "The transiting North Node is opposite your natal Sun — sitting on your South Node — drawing identity into contrast with past patterns of self-expression. The familiar ways of being yourself may feel constraining; the invitation is toward the self you have not yet become.",

    # Transiting North Node → natal Moon
    ("North Node", "Moon", "conjunction"): "The transiting North Node is crossing your natal Moon, activating the evolutionary dimension of your emotional life. Instincts and feelings that point forward — toward growth rather than comfort — may arise with unusual clarity, and patterns that have served their purpose come into focus.",
    ("North Node", "Moon", "sextile"):     "The transiting North Node is gently supporting your natal Moon, making it easier to follow feelings that serve genuine growth rather than merely seeking what is safe. Emotional intelligence is available in service of evolution; instincts tend to point forward in this window.",
    ("North Node", "Moon", "square"):      "The transiting North Node is squaring your natal Moon, creating friction between emotional habit and the direction of soul growth. An instinctive response or comfort-seeking pattern may be getting in the way of forward movement — the tension is pointing at what needs to shift.",
    ("North Node", "Moon", "trine"):       "The transiting North Node is flowing naturally into your natal Moon, aligning emotional instinct with growth direction. Following your feelings tends to move you forward rather than backward right now; the emotional body is briefly enlisted in service of what your soul is becoming.",
    ("North Node", "Moon", "opposition"):  "The transiting North Node is opposite your natal Moon — activating the South Node axis of emotional habit — surfacing deeply familiar comfort patterns. Old emotional responses that no longer serve are prominent; the awareness they bring is useful for understanding what needs to evolve.",

    # Transiting North Node → natal Mercury
    ("North Node", "Mercury", "conjunction"): "The transiting North Node is crossing your natal Mercury, enrolling your mind and communication in the service of evolutionary growth. Conversations, ideas, or learning that arrive now tend to point meaningfully forward — pay attention to what gets said or thought in this window.",
    ("North Node", "Mercury", "sextile"):     "The transiting North Node is gently supporting your natal Mercury, making it easy to think and speak in ways that align with your growth direction. A good window for conversations that open doors or ideas that feel both genuine and forward-pointing.",
    ("North Node", "Mercury", "square"):      "The transiting North Node is squaring your natal Mercury, creating mild friction between familiar ways of thinking and the direction of soul growth. A habitual thought pattern or communication style may need to be examined before clear forward movement is possible.",
    ("North Node", "Mercury", "trine"):       "The transiting North Node is flowing naturally into your natal Mercury, aligning thought and communication with evolutionary purpose. Ideas that feel both true and forward-pointing are available; conversations in this window can meaningfully advance where you are going.",
    ("North Node", "Mercury", "opposition"):  "The transiting North Node is opposite your natal Mercury — touching the South Node axis of mental habit — surfacing ingrained ways of thinking and speaking. Familiar ideas and habitual communication patterns are prominent; recognizing them is the first step toward thinking in genuinely new ways.",

    # Transiting North Node → natal Venus
    ("North Node", "Venus", "conjunction"): "The transiting North Node is crossing your natal Venus, bringing love, values, and relational life into contact with the direction of soul growth. Encounters and connections made in this window have a way of feeling both genuinely attractive and meaningfully forward-pointing.",
    ("North Node", "Venus", "sextile"):     "The transiting North Node is gently supporting your natal Venus, making relational warmth and growth direction cooperate naturally. A good window for connections that serve your evolution or values that feel both genuine and forward-facing.",
    ("North Node", "Venus", "square"):      "The transiting North Node is squaring your natal Venus, creating gentle friction between what feels comfortable or desirable and where your soul is growing. A relationship pattern or attachment may be gently tested against your larger life direction.",
    ("North Node", "Venus", "trine"):       "The transiting North Node is flowing harmoniously into your natal Venus, making love, beauty, and relational life feel aligned with your growth direction. Connections deepened in this window tend to serve genuine evolution rather than comfortable familiarity.",
    ("North Node", "Venus", "opposition"):  "The transiting North Node is opposite your natal Venus — activating the South Node axis of relational habit — surfacing familiar patterns in love and what you find attractive. Old attachment styles are visible; the invitation is toward more evolving forms of connection.",

    # Transiting North Node → natal Mars
    ("North Node", "Mars", "conjunction"): "The transiting North Node is crossing your natal Mars, directing drive and initiative into the service of evolutionary growth. Actions taken now have a way of pointing life forward; the energy is available and the direction is meaningful — move deliberately rather than reactively.",
    ("North Node", "Mars", "sextile"):     "The transiting North Node is gently supporting your natal Mars, making assertive energy available in service of your growth direction. Effort toward forward-facing goals meets less resistance than usual — a useful window for pushing through inertia with genuine purpose.",
    ("North Node", "Mars", "square"):      "The transiting North Node is squaring your natal Mars, creating friction between how you are currently asserting yourself and where your soul is growing. Old action patterns or habitual drives may be getting in the way — the tension names where initiative and direction need to be realigned.",
    ("North Node", "Mars", "trine"):       "The transiting North Node is flowing naturally into your natal Mars, aligning physical drive with evolutionary purpose. Actions taken with genuine intent tend to advance the soul's direction right now — a good period for decisive, forward-moving effort.",
    ("North Node", "Mars", "opposition"):  "The transiting North Node is opposite your natal Mars — activating the South Node axis of old warrior patterns — surfacing ingrained drives and habitual ways of asserting yourself. Notice what gets triggered and whether those responses still serve where you are actually going.",

    # Transiting North Node → natal Jupiter
    ("North Node", "Jupiter", "conjunction"): "The transiting North Node is crossing your natal Jupiter, amplifying the expansive dimension of your growth direction. Optimism, opportunity, and philosophical alignment with your soul's purpose are available — this window supports genuine growth rather than comfortable repetition.",
    ("North Node", "Jupiter", "sextile"):     "The transiting North Node is gently supporting your natal Jupiter, opening doors of expansion that align with your growth direction. Good fortune that arrives tends to feel meaningfully forward-facing; a good window to say yes to what genuinely expands your soul's path.",
    ("North Node", "Jupiter", "square"):      "The transiting North Node is squaring your natal Jupiter, creating friction between the desire for expansion and your soul's actual growth direction. The urge to grow may be real, but the direction or scale may need recalibrating before it truly serves your evolution.",
    ("North Node", "Jupiter", "trine"):       "The transiting North Node is flowing harmoniously into your natal Jupiter, making growth and genuine opportunity feel aligned. The expansion available in this window tends to serve your soul's direction rather than just your comfort — a good period for genuine forward movement.",
    ("North Node", "Jupiter", "opposition"):  "The transiting North Node is opposite your natal Jupiter — activating the South Node axis of past abundance — surfacing old beliefs, familiar optimism, and comfortable philosophical territory. The invitation is to ensure expansion is serving growth rather than simply reproducing what has always felt abundant.",

    # Transiting North Node → natal Saturn
    ("North Node", "Saturn", "conjunction"): "The transiting North Node is crossing your natal Saturn, bringing the discipline and structure of your soul's evolutionary work into focus. Growth in this window requires not inspiration alone but genuine effort, patience, and willingness to build toward what actually matters.",
    ("North Node", "Saturn", "sextile"):     "The transiting North Node is gently supporting your natal Saturn, lending structure and steadiness to your growth direction. Disciplined effort applied toward forward-facing goals in this window tends to produce lasting results.",
    ("North Node", "Saturn", "square"):      "The transiting North Node is squaring your natal Saturn, applying pressure to the gap between where your structures are and where your soul is growing. Old obligations, fears, or rigid patterns may be creating resistance — the friction names what needs to be restructured or released.",
    ("North Node", "Saturn", "trine"):       "The transiting North Node is flowing steadily into your natal Saturn, aligning discipline with evolutionary purpose. Consistent, patient effort toward your growth direction in this window is rewarded; what you build now carries real significance.",
    ("North Node", "Saturn", "opposition"):  "The transiting North Node is opposite your natal Saturn — activating the South Node axis of old structures and karmic obligations — surfacing inherited limitations and duties from the past. What has been carried too long may be creating genuine drag on forward movement.",

    # Transiting North Node → natal Uranus
    ("North Node", "Uranus", "conjunction"): "The transiting North Node is crossing your natal Uranus, bringing the awakening dimension of your nature into the service of soul growth. Sudden insights or unexpected changes tend to be oriented toward genuine evolution rather than mere disruption in this window.",
    ("North Node", "Uranus", "sextile"):     "The transiting North Node is gently supporting your natal Uranus, making originality and forward-breaking moves available in service of your growth direction. Unconventional approaches to your soul's path feel not just possible but genuinely useful right now.",
    ("North Node", "Uranus", "square"):      "The transiting North Node is squaring your natal Uranus, creating friction between the impulse to disrupt and the direction of evolutionary growth. Change for its own sake may not be serving the soul's actual purpose — the tension is pointing toward more deliberate innovation.",
    ("North Node", "Uranus", "trine"):       "The transiting North Node is flowing naturally into your natal Uranus, aligning originality with evolutionary purpose. The willingness to break with convention carries you forward rather than sideways — unconventional choices tend to serve your growth in this window.",
    ("North Node", "Uranus", "opposition"):  "The transiting North Node is opposite your natal Uranus — activating the South Node axis of old rebellions — surfacing familiar forms of disruption and ingrained unconventionality. Notice whether the disruption is genuinely serving evolution or simply reproducing comfortable forms of being different.",

    # Transiting North Node → natal Neptune
    ("North Node", "Neptune", "conjunction"): "The transiting North Node is crossing your natal Neptune, bringing spirituality and the dissolving of boundaries into the service of soul growth. What you dream, intuit, and long for spiritually may be pointing meaningfully toward your evolutionary direction in this window.",
    ("North Node", "Neptune", "sextile"):     "The transiting North Node is gently supporting your natal Neptune, opening a quiet spiritual current that aligns with your growth direction. Intuition and compassion are useful guides right now — follow feeling over logic when navigating your soul's path.",
    ("North Node", "Neptune", "square"):      "The transiting North Node is squaring your natal Neptune, creating gentle friction between spiritual ideals and the direction of genuine growth. Old illusions or spiritual bypassing may be clouding the path forward — clarity and discernment are being asked for.",
    ("North Node", "Neptune", "trine"):       "The transiting North Node is flowing naturally into your natal Neptune, giving a spiritual, intuitive quality to forward movement. Dreams, synchronicities, and quiet inner knowing may be pointing the way with unusual reliability in this window.",
    ("North Node", "Neptune", "opposition"):  "The transiting North Node is opposite your natal Neptune — activating the South Node axis of old spiritual patterns — surfacing familiar longings and past-life spiritual ideals. The invitation is toward spiritual grounding and genuine growth rather than comfortable retreat.",

    # Transiting North Node → natal Pluto
    ("North Node", "Pluto", "conjunction"): "The transiting North Node is crossing your natal Pluto, enrolling the transformative depth of your nature in the service of evolutionary growth. What you are capable of transforming in yourself and in the world is being called toward its highest expression in this window.",
    ("North Node", "Pluto", "sextile"):     "The transiting North Node is gently supporting your natal Pluto, making deep transformation available in service of your growth direction. Profound change is possible without catastrophic disruption — a deliberate approach to releasing what no longer serves can be unusually effective.",
    ("North Node", "Pluto", "square"):      "The transiting North Node is squaring your natal Pluto, applying evolutionary pressure to the deep, transformative dimension of your nature. Power dynamics, buried material, or compulsive patterns may be surfacing and demanding reckoning before genuine forward movement is possible.",
    ("North Node", "Pluto", "trine"):       "The transiting North Node is flowing powerfully into your natal Pluto, aligning depth and transformation with evolutionary purpose. The capacity for profound renewal is available in service of your soul's growth direction — change made in this window tends to be lasting and genuinely soul-oriented.",
    ("North Node", "Pluto", "opposition"):  "The transiting North Node is opposite your natal Pluto — activating the South Node axis of karmic power and soul-level material — surfacing buried compulsions and past-life patterns around power. What erupts from the underground has a way of clearing ground for genuine evolution.",

    # Transiting North Node → natal ASC
    ("North Node", "ASC", "conjunction"): "The transiting North Node is crossing your Ascendant, bringing the direction of soul growth directly into the domain of identity and how you meet the world. Encounters and new beginnings carry an evolutionary charge — a meaningful window for authentic presence aligned with your growth direction.",
    ("North Node", "ASC", "sextile"):     "The transiting North Node is gently supporting your Ascendant, making personal presence and your growth direction easy to align. It is unusually natural right now to show up in the world in ways that also serve your soul's forward path.",
    ("North Node", "ASC", "square"):      "The transiting North Node is squaring your Ascendant, creating friction between how you currently present yourself and the direction of evolutionary growth. Something about your outward manner may need to shift before the soul can move clearly forward.",
    ("North Node", "ASC", "trine"):       "The transiting North Node is flowing harmoniously into your Ascendant, making authentic self-presentation and your growth direction feel naturally aligned. How you show up in the world tends to serve your evolution rather than contradict it in this window.",
    ("North Node", "ASC", "opposition"):  "The transiting North Node is opposite your Ascendant — on your Descendant — directing evolutionary energy through the domain of close partnership. Other people may be the primary catalyst for soul growth right now; what the soul is learning often arrives through relationship.",

    # Transiting North Node → natal DSC
    ("North Node", "DSC", "conjunction"): "The transiting North Node is crossing your Descendant, bringing the direction of soul growth into the realm of close partnership and what you seek in others. Significant relationships formed or deepened in this window may carry an evolutionary quality — who you are drawn to can show you where you are growing.",
    ("North Node", "DSC", "sextile"):     "The transiting North Node is gently supporting your Descendant, making partnership and growth direction naturally cooperative. Connections that serve genuine evolution are available — others may offer exactly what the soul needs to move forward right now.",
    ("North Node", "DSC", "square"):      "The transiting North Node is squaring your Descendant, creating productive friction between your relationship patterns and the direction of soul growth. Something about who you attract or what you seek in partnership may be at odds with where your soul is evolving.",
    ("North Node", "DSC", "trine"):       "The transiting North Node is flowing harmoniously into your Descendant, aligning the relational dimension of your life with your growth direction. The people who enter or deepen in your life in this window tend to serve your evolution — connection and soul growth feel briefly aligned.",
    ("North Node", "DSC", "opposition"):  "The transiting North Node is opposite your Descendant — on your Ascendant — directing evolutionary energy through identity and the personal self. Growth right now may come less through relationship and more through clarifying who you genuinely are.",

    # Transiting North Node → natal MC
    ("North Node", "MC", "conjunction"): "The transiting North Node is crossing your Midheaven, aligning your professional direction and public role with the evolutionary path of your soul. Career choices, public commitments, and your relationship with authority carry an evolutionary charge in this window.",
    ("North Node", "MC", "sextile"):     "The transiting North Node is gently supporting your Midheaven, making career direction and soul growth naturally cooperative. Professional choices that feel genuinely forward-facing are accessible — the path of career and the path of soul are briefly pointing the same way.",
    ("North Node", "MC", "square"):      "The transiting North Node is squaring your Midheaven, creating productive friction between your professional direction and the direction of soul growth. Career goals or the public role you have built may need to be examined against your larger evolutionary purpose.",
    ("North Node", "MC", "trine"):       "The transiting North Node is flowing harmoniously into your Midheaven, aligning professional ambition with evolutionary purpose. Career moves made from genuine vocation rather than mere status tend to serve the soul's direction right now.",
    ("North Node", "MC", "opposition"):  "The transiting North Node is opposite your Midheaven — on your IC — directing evolutionary energy toward the private foundations of your life. Home, family, and the psychological roots of your sense of self may be where the most meaningful soul growth is available right now.",

    # Transiting North Node → natal IC
    ("North Node", "IC", "conjunction"): "The transiting North Node is crossing your IC, bringing the direction of soul growth into the domain of home, family, and private foundations. Deep inner work — examining roots, family patterns, and the psychological ground you stand on — carries the most evolutionary charge in this window.",
    ("North Node", "IC", "sextile"):     "The transiting North Node is gently supporting your IC, making private, inner growth easily available. A good period for working with home, family, or psychological roots in ways that serve your larger evolutionary direction.",
    ("North Node", "IC", "square"):      "The transiting North Node is squaring your IC, creating friction between your private foundations and the direction of soul growth. Old family patterns, inherited beliefs, or unresolved roots may be creating drag on forward movement — the friction names what needs to be faced inwardly.",
    ("North Node", "IC", "trine"):       "The transiting North Node is flowing naturally into your IC, aligning inner work and private foundations with evolutionary purpose. Working with your roots — family patterns, psychological ground, inner life — tends to support forward movement in this window.",
    ("North Node", "IC", "opposition"):  "The transiting North Node is opposite your IC — on your Midheaven — directing evolutionary energy toward career, public life, and your role in the larger world. What you are being called to build publicly may be the primary site of soul growth right now.",

    # Transiting North Node → natal North Node
    ("North Node", "North Node", "conjunction"): "The transiting North Node is returning to your natal North Node — a nodal return, occurring approximately every 18.6 years. Your soul's current growth direction and the growth direction you were born with are briefly aligned. A significant window for recommitment to what genuinely matters in your evolutionary path.",
    ("North Node", "North Node", "sextile"):     "The transiting North Node is in a supportive relationship with your natal North Node, making it easier to move in your evolutionary direction. Growth and soul purpose feel naturally cooperative — a good window for choices and actions that serve what you are here to develop.",
    ("North Node", "North Node", "square"):      "The transiting North Node is squaring your natal North Node, creating productive friction in the dimension of soul growth. The current collective growth direction and your personal evolutionary path may not be perfectly aligned — the tension is pointing toward recalibration of your direction.",
    ("North Node", "North Node", "trine"):       "The transiting North Node is flowing harmoniously with your natal North Node, supporting forward movement on your soul's path with unusual ease. Growth feels accessible and naturally oriented — a good window for taking meaningful steps in your evolutionary direction.",
    ("North Node", "North Node", "opposition"):  "The transiting North Node is opposite your natal North Node — the nodal opposition, occurring approximately nine years after birth and repeating in that cycle. The current collective evolutionary direction stands across from your natal growth direction. What you are here to develop is being seen from a new angle; what was unfamiliar in your purpose is becoming more conscious.",

    # Transiting North Node → natal South Node
    ("North Node", "South Node", "conjunction"): "The transiting North Node is crossing your natal South Node — the point where the current collective growth direction meets your deepest past. Old patterns and ingrained habits surface with unusual clarity, making it easier to see both what has been truly useful and what has been carried too long.",
    ("North Node", "South Node", "sextile"):     "The transiting North Node is gently supporting your natal South Node, making past gifts and past patterns available in a way that can serve forward movement. Old strengths are accessible; the invitation is to draw on them deliberately rather than revert to them automatically.",
    ("North Node", "South Node", "square"):      "The transiting North Node is squaring your natal South Node, creating friction between the current collective growth direction and your deepest ingrained patterns. What has been most comfortable and familiar may feel most challenged right now — the tension is evolutionary.",
    ("North Node", "South Node", "trine"):       "The transiting North Node is flowing harmoniously into your natal South Node, making the gifts and wisdom of your past available in service of forward movement. What you carry from before is being recognized and redirected — old strengths find a new purpose.",
    ("North Node", "South Node", "opposition"):  "The transiting North Node is opposite your natal South Node — aligning with your natal North Node — where the current collective growth direction meets your personal evolutionary direction. What you were born to develop and what the collective is currently learning are briefly in resonance — a potent window for evolutionary purpose.",

    # ── Transiting South Node to natal planets ────────────────────────────────
    # The South Node activates the past-comfort zone, karmic inheritance, and soul-level review.

    # Transiting South Node → natal Sun
    ("South Node", "Sun", "conjunction"):  "The transiting South Node is crossing your natal Sun, activating familiar patterns of identity and ingrained ways of being yourself. Old habits of self-expression resurface — a window for recognizing what has crystallized into habit in your sense of self and what is genuinely worth carrying forward.",
    ("South Node", "Sun", "sextile"):      "The transiting South Node is gently supporting your natal Sun, making past gifts of identity and self-expression easily accessible. Old strengths are available with natural ease; the invitation is to draw on them deliberately while staying open to what identity is being called to evolve beyond.",
    ("South Node", "Sun", "square"):       "The transiting South Node is squaring your natal Sun, creating friction between past patterns of self-expression and your current growth direction. A comfortable but limiting self-image may be resisting evolution — the tension is pointing at what needs to shift in how you present yourself.",
    ("South Node", "Sun", "trine"):        "The transiting South Node is flowing easily into your natal Sun, making familiar self-expression feel natural and accessible. Past gifts of confidence and identity are readily available — genuine assets, though the invitation is to ensure comfort in being yourself isn't substituting for the growth being called for.",
    ("South Node", "Sun", "opposition"):   "The transiting South Node is opposite your natal Sun — sitting on your North Node — pulling past patterns of identity into contrast with your growth direction. Old ways of being yourself are prominent; the invitation is to notice what is being left behind as you move toward who you are becoming.",

    # Transiting South Node → natal Moon
    ("South Node", "Moon", "conjunction"): "The transiting South Node is crossing your natal Moon, activating deeply familiar emotional patterns and instincts from the past. Old comfort-seeking behaviors and habitual feelings surface — a moment for recognition rather than automatic indulgence of what no longer serves growth.",
    ("South Node", "Moon", "sextile"):     "The transiting South Node is gently supporting your natal Moon, making familiar emotional intelligence and past instincts accessible. Past emotional gifts are available — worth noticing when they encourage retreat into comfort rather than genuine forward movement.",
    ("South Node", "Moon", "square"):      "The transiting South Node is squaring your natal Moon, creating friction between old emotional habits and the direction of genuine development. A habitual emotional response or comfort-seeking behavior may be resisting change — the friction is pointing at what needs to shift.",
    ("South Node", "Moon", "trine"):       "The transiting South Node is flowing easily into your natal Moon, making familiar emotional territory feel especially comfortable and safe. The ease is real, but so is the risk of defaulting to old patterns — the invitation is to enjoy emotional ease without letting it substitute for genuine growth.",
    ("South Node", "Moon", "opposition"):  "The transiting South Node is opposite your natal Moon — sitting on your North Node — pulling emotional habit into contrast with your growth direction. Old emotional patterns are prominent; the awareness of what no longer serves is the beginning of forward movement.",

    # Transiting South Node → natal Mercury
    ("South Node", "Mercury", "conjunction"): "The transiting South Node is crossing your natal Mercury, activating familiar mental patterns, old ideas, and habitual ways of communicating. Past thinking styles resurface — useful for recognizing what has crystallized into habit rather than genuine, living understanding.",
    ("South Node", "Mercury", "sextile"):     "The transiting South Node is gently supporting your natal Mercury, making past knowledge and familiar intellectual styles easy to draw on. Old mental gifts are accessible; the invitation is to use established thinking in service of new understanding rather than as a substitute for it.",
    ("South Node", "Mercury", "square"):      "The transiting South Node is squaring your natal Mercury, creating friction between familiar thought patterns and the need for fresh perspective. An ingrained way of thinking or speaking may be limiting your ability to see things genuinely new — the tension is naming it.",
    ("South Node", "Mercury", "trine"):       "The transiting South Node is flowing easily into your natal Mercury, making established mental patterns and familiar ways of communicating feel effortless. Genuine intellectual gifts from the past are accessible — the invitation is to use them as tools for real understanding, not just as comfortable frameworks.",
    ("South Node", "Mercury", "opposition"):  "The transiting South Node is opposite your natal Mercury — sitting on your North Node — drawing familiar mental habits into contrast with your growth direction. Old ways of processing information are prominent; the recognition creates room for genuinely new thought.",

    # Transiting South Node → natal Venus
    ("South Node", "Venus", "conjunction"): "The transiting South Node is crossing your natal Venus, activating familiar relational patterns and ingrained values around love and beauty. Old attachments and comfortable ways of relating resurface — a moment for seeing what has calcified into habit in your relationship world.",
    ("South Node", "Venus", "sextile"):     "The transiting South Node is gently supporting your natal Venus, making past relational gifts and familiar ways of connecting feel accessible and pleasant. Draw on genuine relational warmth while remaining open to how love and values are being asked to grow.",
    ("South Node", "Venus", "square"):      "The transiting South Node is squaring your natal Venus, generating friction between comfort in love and the need for relational growth. An old pattern in how you relate or what you find attractive may be creating drag — the tension is pointing at it.",
    ("South Node", "Venus", "trine"):       "The transiting South Node is flowing easily into your natal Venus, making familiar relationship patterns and comfortable pleasures feel effortless. Past gifts of love and beauty are accessible; the invitation is to notice when comfortable connection substitutes for the more demanding work of relational growth.",
    ("South Node", "Venus", "opposition"):  "The transiting South Node is opposite your natal Venus — sitting on your North Node — pulling relational comfort into contrast with your growth direction. Old ways of connecting and what you find attractive are prominent; the awareness is pointing toward more evolving forms of love.",

    # Transiting South Node → natal Mars
    ("South Node", "Mars", "conjunction"): "The transiting South Node is crossing your natal Mars, stirring up deeply ingrained patterns of drive, assertion, and old ways of seeking what you want. Past action patterns resurface with energy — a moment for examining whether old strategies of initiative still fit who you are becoming.",
    ("South Node", "Mars", "sextile"):     "The transiting South Node is gently supporting your natal Mars, making past assertive gifts and familiar action patterns feel available and effective. Old strengths in initiative are accessible — the invitation is to direct that energy forward rather than simply recycling what has always worked.",
    ("South Node", "Mars", "square"):      "The transiting South Node is squaring your natal Mars, generating friction with old patterns of assertion or impulsivity. A habitual way of fighting or pushing may be creating unnecessary resistance right now — the tension is pointing at what needs to be released or redirected.",
    ("South Node", "Mars", "trine"):       "The transiting South Node is flowing easily into your natal Mars, making old assertive patterns and familiar drives feel natural and effective. Past courage and initiative are available — genuinely useful, though worth questioning whether the old approach still fits the current situation.",
    ("South Node", "Mars", "opposition"):  "The transiting South Node is opposite your natal Mars — sitting on your North Node — drawing familiar fighting patterns into contrast with your growth direction. Notice where old action instincts are present and whether they are still serving your actual forward path.",

    # Transiting South Node → natal Jupiter
    ("South Node", "Jupiter", "conjunction"): "The transiting South Node is crossing your natal Jupiter, amplifying familiar beliefs, past-life abundance, and old philosophical comfort zones. The gifts of past optimism and generosity are available — valuable as foundations for genuine growth, potentially limiting when they become the destination.",
    ("South Node", "Jupiter", "sextile"):     "The transiting South Node is gently supporting your natal Jupiter, making past wisdom, familiar optimism, and old forms of abundance easily accessible. Draw on genuine philosophical gifts while staying open to where belief systems may need to grow beyond what has always felt true.",
    ("South Node", "Jupiter", "square"):      "The transiting South Node is squaring your natal Jupiter, creating friction with old belief systems, past philosophical comfort, or ingrained forms of optimism. A comfortable but limiting worldview may be generating resistance — the tension is pointing at what needs to expand beyond the familiar.",
    ("South Node", "Jupiter", "trine"):       "The transiting South Node is flowing easily into your natal Jupiter, making past philosophical gifts and familiar forms of good fortune feel natural and accessible. Genuine wisdom from prior experience is available; the invitation is to use it as a springboard for new growth rather than a resting place.",
    ("South Node", "Jupiter", "opposition"):  "The transiting South Node is opposite your natal Jupiter — sitting on your North Node — drawing past-life abundance and familiar optimism into contrast with your growth direction. Old philosophical frameworks are prominent; the recognition creates room for a larger, more evolved worldview.",

    # Transiting South Node → natal Saturn
    ("South Node", "Saturn", "conjunction"): "The transiting South Node is crossing your natal Saturn, activating old structures, ingrained obligations, and past-life patterns of discipline and limitation. Familiar constraints and habitual duties resurface — a significant window for examining which responsibilities are still genuine and which have become mere habit.",
    ("South Node", "Saturn", "sextile"):     "The transiting South Node is gently supporting your natal Saturn, making past discipline, old structures, and familiar competence feel dependable and accessible. Past mastery is a genuine resource; the invitation is to use it to build forward rather than to simply reproduce what has always worked.",
    ("South Node", "Saturn", "square"):      "The transiting South Node is squaring your natal Saturn, applying friction to old structures, inherited obligations, and familiar ways of taking responsibility. A pattern of duty or limitation that has outlived its usefulness is being pressured — the discomfort is pointing at what needs to be restructured or released.",
    ("South Node", "Saturn", "trine"):       "The transiting South Node is flowing easily into your natal Saturn, making old disciplines and inherited competence feel steady and accessible. Past mastery is a real asset in this window; the key is directing that capability toward genuine forward movement rather than comfortable repetition.",
    ("South Node", "Saturn", "opposition"):  "The transiting South Node is opposite your natal Saturn — sitting on your North Node — drawing old obligations and familiar limitations into contrast with your growth direction. Past duties are prominent; recognizing what has been carried long enough creates room for new forms of responsibility to emerge.",

    # Transiting South Node → natal Uranus
    ("South Node", "Uranus", "conjunction"): "The transiting South Node is crossing your natal Uranus, activating past-life patterns of rebellion, disruption, and familiar forms of originality. Old ways of being unconventional resurface — a moment for examining whether ingrained forms of being different are serving genuine innovation or just comfortable contrarianism.",
    ("South Node", "Uranus", "sextile"):     "The transiting South Node is gently supporting your natal Uranus, making past innovations and familiar forms of originality feel fresh and accessible. Old unconventional gifts are available — the invitation is to direct that originality toward genuinely forward-moving purposes.",
    ("South Node", "Uranus", "square"):      "The transiting South Node is squaring your natal Uranus, generating friction with ingrained patterns of rebellion or disruption. An old way of being unconventional may itself have become a comfortable habit — the tension is pointing at what needs to evolve in how you relate to change and originality.",
    ("South Node", "Uranus", "trine"):       "The transiting South Node is flowing easily into your natal Uranus, making past innovations and familiar forms of independence feel electric and accessible. Genuine originality is available; the invitation is to direct that creative freedom toward new purposes rather than old rebellions.",
    ("South Node", "Uranus", "opposition"):  "The transiting South Node is opposite your natal Uranus — sitting on your North Node — drawing familiar unconventionality into contrast with your growth direction. Old forms of rebellion are prominent; the awareness creates room for originality to serve genuinely new purposes.",

    # Transiting South Node → natal Neptune
    ("South Node", "Neptune", "conjunction"): "The transiting South Node is crossing your natal Neptune, activating past-life spiritual patterns, deep karmic longings, and familiar forms of dissolution. Old spiritual gifts and spiritual wounds alike may surface — a window of gradual release rather than confrontation.",
    ("South Node", "Neptune", "sextile"):     "The transiting South Node is gently supporting your natal Neptune, making past spiritual gifts and familiar compassion accessible in a soft, flowing way. Past-life sensitivity is available; draw on it without retreating into old forms of escapism or idealization.",
    ("South Node", "Neptune", "square"):      "The transiting South Node is squaring your natal Neptune, generating gentle friction with old spiritual patterns and ingrained forms of self-dissolution. Something about the old way of seeking transcendence may be creating confusion — clarity and discernment are being asked for.",
    ("South Node", "Neptune", "trine"):       "The transiting South Node is flowing easily into your natal Neptune, making past spiritual gifts and familiar compassion feel natural and available. Old spiritual ease is accessible; the invitation is to let it serve genuine forward-moving spirituality rather than comfortable retreat.",
    ("South Node", "Neptune", "opposition"):  "The transiting South Node is opposite your natal Neptune — sitting on your North Node — drawing past spiritual longings and familiar dissolution into contrast with your growth direction. Old spiritual patterns are prominent; the recognition creates space for a more grounded and genuinely evolving spiritual life.",

    # Transiting South Node → natal Pluto
    ("South Node", "Pluto", "conjunction"): "The transiting South Node is crossing your natal Pluto, activating past-life patterns of power, compulsion, and deep soul-level intensity. Old material around control and transformation resurfaces with force — a window for recognizing and deliberately releasing what has been carried too long.",
    ("South Node", "Pluto", "sextile"):     "The transiting South Node is gently supporting your natal Pluto, making past depth and transformative gifts accessible without catastrophic disruption. Old capacity for profound change is available — the invitation is to use it to consciously clear past material rather than simply to revisit it.",
    ("South Node", "Pluto", "square"):      "The transiting South Node is squaring your natal Pluto, driving friction into past patterns of power and entrenched soul-level material. Old compulsions or buried psychological material resurface with force — the pressure is pointing at what needs to be transformed rather than suppressed.",
    ("South Node", "Pluto", "trine"):       "The transiting South Node is flowing easily into your natal Pluto, making past transformative gifts and old depth accessible in this window. The capacity for profound inner change is available; the invitation is to direct it toward what is genuinely ready to be released and renewed.",
    ("South Node", "Pluto", "opposition"):  "The transiting South Node is opposite your natal Pluto — sitting on your North Node — drawing past-life power patterns and buried soul material into contrast with your growth direction. What has been most deeply ingrained is becoming most visible — the awareness itself is part of the transformation.",

    # Transiting South Node → natal ASC
    ("South Node", "ASC", "conjunction"): "The transiting South Node is crossing your Ascendant, activating familiar patterns of how you present yourself to the world. Old personality habits and ingrained ways of meeting others resurface — a window for recognizing which aspects of your outward self are genuinely you and which have simply become automatic.",
    ("South Node", "ASC", "sextile"):     "The transiting South Node is gently supporting your Ascendant, making familiar self-presentation and past approaches to the world feel natural and accessible. Old social ease is available; the invitation is to draw on genuine confidence while remaining open to how identity is being asked to evolve.",
    ("South Node", "ASC", "square"):      "The transiting South Node is squaring your Ascendant, creating friction between familiar ways of presenting yourself and the direction of your growth. An ingrained habit in how you meet the world may be limiting what is genuinely possible — the tension is naming it.",
    ("South Node", "ASC", "trine"):       "The transiting South Node is flowing easily into your Ascendant, making familiar self-expression and comfortable presence feel natural. Past gifts of social ease and personal presence are accessible; the invitation is to use that ease in service of genuine forward movement.",
    ("South Node", "ASC", "opposition"):  "The transiting South Node is opposite your Ascendant — on your Descendant — activating familiar relationship patterns and past ways of engaging with others. Old dynamics in how you relate are prominent; the awareness creates space for more evolving forms of partnership.",

    # Transiting South Node → natal DSC
    ("South Node", "DSC", "conjunction"): "The transiting South Node is crossing your Descendant, activating old patterns in how you relate to others and what you habitually seek in partnership. Familiar relationship dynamics resurface — a window for recognizing what has become automatic in your approach to close bonds.",
    ("South Node", "DSC", "sextile"):     "The transiting South Node is gently supporting your Descendant, making past relational gifts and familiar ways of engaging with others accessible. Old patterns of partnership are available to draw from; the invitation is to use what has been genuinely good in past relating while opening to what is evolving.",
    ("South Node", "DSC", "square"):      "The transiting South Node is squaring your Descendant, generating friction with old relational patterns and habitual ways of engaging in partnership. Something about who you typically attract or what you seek in others may be at odds with your growth direction.",
    ("South Node", "DSC", "trine"):       "The transiting South Node is flowing easily into your Descendant, making familiar relational patterns and past ways of connecting feel comfortable and accessible. Past gifts in partnership are available; the invitation is to draw on them deliberately rather than simply repeating what has always been comfortable.",
    ("South Node", "DSC", "opposition"):  "The transiting South Node is opposite your Descendant — on your Ascendant — activating familiar identity patterns and past ways of being yourself. Old habits of self-presentation are prominent; the awareness creates space for identity to evolve.",

    # Transiting South Node → natal MC
    ("South Node", "MC", "conjunction"): "The transiting South Node is crossing your Midheaven, activating familiar professional patterns and past ways of engaging with career and public life. Old ambitions and ingrained professional identities resurface — a window for reviewing what in the career sphere has become habit rather than genuine purpose.",
    ("South Node", "MC", "sextile"):     "The transiting South Node is gently supporting your Midheaven, making past professional gifts and familiar approaches to career feel accessible and useful. Old competence is available; the invitation is to draw on established mastery while staying open to where career and purpose are being called to evolve.",
    ("South Node", "MC", "square"):      "The transiting South Node is squaring your Midheaven, creating friction between familiar professional patterns and the direction of your soul's growth. Old career habits or established professional identity may be resisting evolution — the tension is naming where genuine recalibration is needed.",
    ("South Node", "MC", "trine"):       "The transiting South Node is flowing easily into your Midheaven, making established professional mastery and familiar career patterns feel natural and accessible. Past gifts in public life are available; the invitation is to ensure they serve genuine purpose rather than simply reproducing comfortable ambition.",
    ("South Node", "MC", "opposition"):  "The transiting South Node is opposite your Midheaven — on your IC — activating familiar private and family patterns. Old foundations of home and inner life are prominent; the awareness creates space for examining what is truly load-bearing in your private world.",

    # Transiting South Node → natal IC
    ("South Node", "IC", "conjunction"): "The transiting South Node is crossing your IC, activating old family patterns, ancestral material, and deeply familiar private foundations. What has been most ingrained in the psychological ground of your sense of self resurfaces — a window for recognizing what has been inherited and what may be ready to be released.",
    ("South Node", "IC", "sextile"):     "The transiting South Node is gently supporting your IC, making past emotional foundations and familiar private patterns accessible. Old psychological resources from family and inner life are available to draw on; the invitation is to use them as genuine support rather than retreat.",
    ("South Node", "IC", "square"):      "The transiting South Node is squaring your IC, creating friction with old family patterns and inherited foundations. What has been most private and familiar in your psychological roots may be creating resistance to genuine growth — the friction is pointing at what needs to be faced or released.",
    ("South Node", "IC", "trine"):       "The transiting South Node is flowing easily into your IC, making familiar private foundations and old family patterns feel comfortable and accessible. Past emotional resources are available; the invitation is to use them as support for forward movement rather than as a destination in themselves.",
    ("South Node", "IC", "opposition"):  "The transiting South Node is opposite your IC — on your Midheaven — activating familiar professional and public patterns. Old ambitions and established career approaches are prominent; the awareness creates space for examining what has been genuine purpose and what has simply been habit.",

    # Transiting South Node → natal North Node
    ("South Node", "North Node", "conjunction"): "The transiting South Node is crossing your natal North Node, creating a significant activation of the nodal axis. The tension between the collective past pattern and your soul's personal growth direction becomes conscious and vivid — a window for seeing clearly what must be released before forward movement becomes genuinely available.",
    ("South Node", "North Node", "sextile"):     "The transiting South Node is gently supporting your natal North Node, making old gifts and past wisdom available in service of your growth direction. Past strengths can be used as foundations for forward movement; the ease of access is real.",
    ("South Node", "North Node", "square"):      "The transiting South Node is squaring your natal North Node, creating friction between the collective pull of the past and your personal evolutionary direction. The tension between familiar comfort and genuine growth is especially clear in this window.",
    ("South Node", "North Node", "trine"):       "The transiting South Node is flowing harmoniously into your natal North Node, making old gifts and past patterns available in ways that serve your growth direction. What you carry from before is being redirected toward what you are becoming rather than what you have been.",
    ("South Node", "North Node", "opposition"):  "The transiting South Node is opposite your natal North Node — a nodal axis alignment — activating the fundamental tension between past comfort and future growth. The contrast between where the soul has been and where it is growing toward is especially vivid and informative in this window.",

    # Transiting South Node → natal South Node
    ("South Node", "South Node", "conjunction"): "The transiting South Node is returning to your natal South Node — a nodal return of the South Node, part of the approximately 18.6-year nodal cycle. Old past-life patterns, deeply ingrained comfort zones, and karmic inheritances are especially vivid. A significant window for recognizing what has been carried longest and what may be ready to be put down.",
    ("South Node", "South Node", "sextile"):     "The transiting South Node is gently supporting your natal South Node, making old patterns, past gifts, and deeply familiar territory feel especially comfortable and accessible. Past strengths are easy to draw on; the invitation is to use them as resources rather than destinations.",
    ("South Node", "South Node", "square"):      "The transiting South Node is squaring your natal South Node, creating friction between different layers of karmic habit. Old patterns are creating drag — the tension is pointing at what has become so habitual it is no longer useful.",
    ("South Node", "South Node", "trine"):       "The transiting South Node is flowing easily into your natal South Node, making familiar past patterns and old strengths feel especially available and comfortable. The gifts of the past are accessible; the wisdom is in drawing on them deliberately while keeping one eye on where growth is calling.",
    ("South Node", "South Node", "opposition"):  "The transiting South Node is opposite your natal South Node — on your natal North Node — a nodal opposition. The collective past pattern and your personal growth direction are in direct contrast, making the tension between comfort and evolution especially clear and available for conscious navigation.",
}
